   ...
   <div className="bg-[#f2f2f2]  rounded-2xl  ps-14 py-5 flex">
       ...
       <div>
        ...
        <div className=" mx-auto p-6 grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#fceee3] p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold">Contact Information</h3>
            <p className="text-gray-600 mb-4">Say something to start a live chat!</p>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <input type="text" name="firstName" placeholder="First Name" className="border-b w-full p-2 outline-none" onChange={handleChange} required />
              ...
              <textarea name="message" placeholder="Write your message..." className="border w-full p-2 outline-none" rows={3} onChange={handleChange} required />
