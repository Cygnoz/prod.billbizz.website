...
function Footer() {
  ...
  return (
    <>
      <div className="relative bg-[#5E0101] text-white p-8">
        <div className="flex flex-col md:flex-row justify-between">
          {/* BillBizz Section */}
          <div className="sm:w-1/6 mb-8 mt-10 md:me-[70px] text-center md:text-left">
            <h2 className="flex text-3xl font-extralight justify-center md:justify-start">
              <img
                src={billbizz}
                alt="BillBizz Logo"
            ...
            <div className="flex flex-col md:flex-row w-full items-center md:items-start">
              <img src={address} alt="" className="mt-5 w-[80%] md:w-full h-auto" />
              <div className="mt-5">
            ...
            <div className="flex  justify-center md:justify-start w-full mb-8 mt-10 gap-5">
              ...
              <img
                ...
                className="w-[100px] md:w-[127px] h-auto md:h-[53px]"
              />
            </div>
          ...
          {/* Quick Links Section */}
          <div className="w-full sm:w-1/6 mb-8 mt-[100px] text-center md:text-left">
        ...
        {/* Footer Bottom Bar */}
        <div className="bg-red-950 flex flex-col md:flex-row justify-between text-center md:text-left h-[38px]">
