        ...
        <div className="flex gap-4">
          ...
          <div className="flex flex-col gap-4">
            <div className="">
              <img
                src={cardimg1}
                className="cursor-pointer h-[331px] w-[402px]"
            ...
            <div className="">
              <img
                src={cardimg3}
                className="cursor-pointer h-[232px] w-[402px]"
          ...
          <div className="flex flex-col gap-2">
            <div className="">
              <img
                src={card2img}
                className="cursor-pointer h-[247px] w-[402px]"
            ...
            <div className="">
              <img
                src={card5img}
                className="cursor-pointer mt-3 h-[313px] w-[402px]"
          ...
          <div className="flex flex-col gap-5">
            <div className="">
              <img
                src={card3img}
                className="cursor-pointer h-[158px] w-[479px]"
            ...
            <div className="">
              <img
                src={card6img}
                className="cursor-pointer h-[399px] w-[479px]"
